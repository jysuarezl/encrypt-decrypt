...
function encrypt() {
    let text = document.getElementById("text__in").value;
    let vocales = /[aeiou]/g;
    ...
    createBtnCopy();
    return document.getElementById("text__out").innerHTML= result;
}
...
function removeBackgroundImage() {
    document.getElementById('text__out').style.backgroundImage = 'none';
    let removeP = document.querySelector('.no__encontrado');
    if (removeP){
      removeP.remove()
    }  
}
...
function createBtnCopy(){ 
    ...
    document.querySelector(".text__out").appendChild(btnCopy);
}
...
function copiar(){
    let text = document.getElementById("text__out").innerHTML;
